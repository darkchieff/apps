...
<head>
  <title>DarkChief - apps
  </title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <meta name="twitter:card" content="summary">
  <meta property="og:title" content="DarkChief">
  <meta property="og:description" content="Website containing access to Xbox homebrew applications such as RetroArch, PPSPP and more.">
  <meta property="og:image" content="https://raw.githubusercontent.com/darkchieff/darkchieff.github.io/main/img/test1.jpg">
  <meta property="og:url" content="https://darkchieff.github.io/">
...
<body>
  <header class="header py-2">
    <nav class="navbar navbar-expand-lg navbar-dark  container">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.html">DarkChief<i class="bi bi-code-slash ms-2"></i></a>
  ...
  <section class="apps py-4">
    <div class="container" id="app">
     ...
     <!-- === WARNINGS SECTION === -->
		...
		<div class="alert col-md-5 my-1">
			<span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
			RetroArch stuck on the logo when opening? Leave Xbox Insider.
		</div>
        ...
        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="400">
          <div class="card text-center">
            ...
            <div class="card-body">
              ...
              <p class="card-text">RetroArch is an open source and cross platform frontend/framework for emulators, game
                engines, video games, media players and other.</p>

              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9P112GNVBB73"
                  class="col-md-5 mb-md-0 mb-3 btn enabled btn-secondary">Download
                  App</a>
                <a data-bs-toggle="modal" data-bs-target="#retroarch" class="col-md-5 btn disabled btn-success">Guide</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="600">
          <div class="card text-center">
            ...
            <div class="card-body">
              ...
              <div class="row justify-content-around">
                <a href="#"
                  class="col-md-5 mb-md-0 mb-3 btn disabled btn-secondary">Download
                  App</a>
        ...
        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="800">
          <div class="card text-center">
            ...
            <div class="card-body">
              <h5 class="card-title">Kodi Matrix</h5>
              <p class="card-text">XBMC.</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9NRT5PHF4SSS"
                  class="col-md-5 mb-md-0 mb-3 btn enabled btn-secondary">Download
                  App</a>
	      ...
	      <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="800">
          <div class="card text-center">
            <img class="card-img-top" src="./img/haloinfinite.png" alt="FTP">
            <div class="card-body">
              <h5 class="card-title">Halo Infinite Insider</h5>
              <p class="card-text">Halo.</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9nnt3kf65xll"
                  class="col-md-5 mb-md-0 mb-3 btn enabled btn-secondary">Download
                  App</a>
                <a data-bs-toggle="modal" data-bs-target="#halo" class="col-md-5 disabled btn btn-success">Guide</a>
              </div>
            </div>
          </div>
        </div>
	        ...
	        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="800">
          <div class="card text-center">
            <img class="card-img-top" src="./img/duck.png" alt="FTP">
            <div class="card-body">
              <h5 class="card-title">DUCKSTATION</h5>
              <p class="card-text">Standalone PS1 Emulator.</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9N05BXXBR0FS"
                  class="col-md-5 mb-md-0 mb-3 btn enabled btn-secondary">Download
                  App</a>
                <a data-bs-toggle="modal" data-bs-target="#DUCK" class="col-md-5 disabled btn btn-success">Guide</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="games py-4">
    <div class="container" id="game">
      ...
      <div class="row">
        ...
        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="600">
          <div class="card text-center">
            ...
            <div class="card-body">
              ...
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9MVGXCVG8Z43"
        ...
        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="600">
          <div class="card text-center">
            <img class="card-img-top" src="./img/am2r.jpg" alt=" Openlara">
            <div class="card-body">
              <h5 class="card-title">AM2R</h5>
              <p class="card-text">Another Metroid 2 Remake</p>
              <div class="row justify-content-around">
                <a href="ms-windows-store://pdp/?productid=9NXP2RB9PFC9"
                  class="col-md-5 mb-md-0 mb-3 btn enabled btn-secondary">Download
                  App</a>
        ...
        <div class="col-md-4 my-3" data-aos="zoom-in" data-aos-duration="600">
          <div class="card text-center">
            <img class="card-img-top" src="./img/minecraft1.jpg" alt=" Openlara">
            <div class="card-body">
  ...
  <section class="faq">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
			...
			<p>
				...
				<br>
				- Copy your ROMs to:
				<br><b>/LOCALFOLDER/8483Dark-Fox.PPlaySPP_e1k75392ey8py/LocalState/PSP/ISO</b>
				<br>
				- You will need to create the ISO folder yourself. Put all of your ISO in here. For CSO files, make a CSO folder instead.
				<br>
				- All of your PSP homebrew goes to:
				<br>
				<b>/LOCALFOLDER/8483Dark-Fox.PPlaySPP_e1k75392ey8py/LocalState/PSP/GAME</b><br>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p>
				...
				- On the <b>Addresses of this device:</b> section, make note of the third part, 128.168.x.x where the x is whatever number shows up for you.<br>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p>
				...
				<br>
				You will have to find and obtain the file by yourself. 
				We don't condone piracy and will not supply the files.
				<br>
				<br>
				...
				<br>
				<em><b>/LOCALFOLDER/8483Dark-Fox.Sonic-CD_e1k75392ey8py/LocalState</b></em>
				<br>
				<br>
    ...
    <div class="modal fade" id="am2r" tabindex="-1" aria-hidden="true">
     ...
     <div class="modal fade" id="minecraft1" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
  ...
  <footer class="footer py-3">
    <div class="container">
      <span>All rights reserved - DarkChief - <script>
